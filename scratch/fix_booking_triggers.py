...
print("Setting up trigger to lock/unlock slots on zenturf_bookings_v2...")
cur.execute("""
...
cur.execute("DROP TRIGGER IF EXISTS zenturf_booking_lock_slot ON public.zenturf_bookings_v2;")
cur.execute("""
